...
<template>
  <div class="relative w-screen h-screen overflow-hidden">
    ...
    <!-- Hover preview (desktop only — not useful on touch) -->
    <HoverPreview
      v-if="!isMobile"
    ...
    <template v-else>
      <Transition name="sheet-up">
        <div
          ...
          class="absolute inset-x-0 bottom-0 z-[1001]"
        ...
        >
          ...
          <!-- Sheet -->
          <div
            class="relative rounded-t-3xl overflow-hidden"
            style="background:rgba(255,255,255,0.99);box-shadow:0 -8px 40px rgba(0,0,0,0.18);"
          >
            <!-- Drag handle -->
